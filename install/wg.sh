...
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cekwg.sh"
wget -O xpwg "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xpwg
