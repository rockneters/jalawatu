...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/addss.sh"
wget -O delss "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
