...
wget https://raw.githubusercontent.com/${GitUser}/jalawatu/main/install/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
bash -c "$(wget -O- https://raw.githubusercontent.com/${GitUser}/jalawatu/main/install/trojan-quickstart.sh)"
mkdir /root/.acme.sh
...
wget -O cekws "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cek-ws.sh"
wget -O cekvless "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cek-vless.sh"
wget -O cektr "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cek-tr.sh"
wget -O renewws "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/renew-ws.sh"
wget -O renewvless "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/renew-vless.sh"
wget -O renewtr "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/renew-tr.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/cert.sh"
wget -O xpws "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/xp-ws.sh"
wget -O xptr "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/menu/xp-tr.sh"
