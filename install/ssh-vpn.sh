...
locality=Indonesia
organization=RSP
organizationalunit=RSP
commonname=RocknetStore
email=rocknetstore82@gmail.com

# simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/password"
...
echo "echo Mod by Rocknet Store Project" >> .profile
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup Mod By Rocknet Store Project</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/vps.conf"
/etc/init.d/nginx restart

# install badvpn
clear
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/${GitUser}/jalawatu/main/install/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /usr/local/ddos/ddos.conf https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/ddos.conf
echo -n '.'
wget -q -O /usr/local/ddos/LICENSE https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/LICENSE
echo -n '.'
wget -q -O /usr/local/ddos/ignore.ip.list https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/ignore.ip.list
echo -n '.'
wget -q -O /usr/local/ddos/ddos.sh https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/ddos.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

#install bbr dan optimasi kernel
wget https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/bbr.sh && chmod +x bbr.sh && ./bbr.sh
wget https://raw.githubusercontent.com/${GitUser}/jalawatu/main/modul/set-br.sh && chmod +x set-br.sh && ./set-br.sh
