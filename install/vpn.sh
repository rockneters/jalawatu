...
cd
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/rockneters/jalawatu/main/modul/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/rockneters/jalawatu/main/modul/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
